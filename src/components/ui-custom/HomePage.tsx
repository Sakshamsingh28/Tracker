  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-100/50 to-zinc-50 flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm">
        <div className="rounded-2xl border border-white/60 bg-white/95 md:bg-white/70 backdrop-blur-none md:backdrop-blur-md shadow-[0_8px_32px_0_rgba(0,0,0,0.04)] p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200/60 bg-white/90 md:bg-white/40 backdrop-blur-none md:backdrop-blur-sm text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900/20 focus:border-transparent transition-all"
              autoFocus
            />
            <button
              type="submit"
